    ...
    <section className="py-24 bg-white" id="who-its-for">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="font-mono text-secondary font-bold tracking-widest text-sm uppercase mb-4 block">WHO THIS IS FOR</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="bg-emerald-50/50 p-8 sm:p-12 rounded-2xl border border-emerald-100">
            <h3 className="text-2xl font-bold text-primary mb-8 flex items-center">
              <span className="w-8 h-8 bg-secondary text-white rounded-full flex items-center justify-center mr-4 text-sm">✓</span>
              This is for you if:
            </h3>
          ...
          <div className="bg-slate-50 p-8 sm:p-12 rounded-2xl border border-slate-200 opacity-80">
            <h3 className="text-2xl font-bold text-primary mb-8 flex items-center">
              <span className="w-8 h-8 bg-slate-400 text-white rounded-full flex items-center justify-center mr-4 text-sm">✕</span>
