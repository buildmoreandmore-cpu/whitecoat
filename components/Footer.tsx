      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <a href="#" className="font-heading text-2xl font-extrabold tracking-tight text-primary mb-4 block">
              WhiteCoat Brief<span className="text-secondary">™</span>
            </a>
            <p className="text-slate-500 max-w-xs leading-relaxed">
              Marketing intelligence for physician-founded brands. We turn medical credentials into competitive advantages.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-500">
              <li><a href="mailto:hello@whitecoatbrief.com" className="hover:text-secondary transition-colors">hello@whitecoatbrief.com</a></li>
        ...
        <div className="pt-8 border-t border-slate-100 text-center text-slate-400 text-sm">
          <p>© 2026 WhiteCoat Brief™ — A Productized Service for Physician Founders.</p>
        </div>
      </div>
    </footer>
  );
