        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
          <div className="lg:col-span-7 xl:col-span-6 mb-12 lg:mb-0">
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-2xl leading-relaxed">
              Your medical credentials are your competitive advantage. The
              WhiteCoat Brief™ turns them into campaigns that convert — with 10
              ad concepts, hook variants, and a 4-week testing roadmap built
