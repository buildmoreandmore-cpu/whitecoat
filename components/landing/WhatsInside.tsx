          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div className="mb-12 lg:mb-0">
              <h3 className="text-2xl font-bold text-primary mb-4">
                Section 01 — Opportunity Landscape
              </h3>
              <p className="text-lg text-slate-600 leading-relaxed italic border-l-4 border-emerald-100 pl-6">
                "We analyze your competitive landscape to find the gaps. What are
                competitors saying? Where are they leaving opportunities? What
                can YOU say that no one else can?"
              </p>
            </div>
...
02  AUTHORITY WITHOUT ARROGANCE
    Warm expertise beats cold clinical.`}
            ...
            <div className="mb-12 lg:mb-0 lg:order-first">
              ...
              <p className="text-lg text-slate-600 leading-relaxed italic border-l-4 border-emerald-100 pl-6">
                "Your positioning statement and three strategic pillars. This is
                the foundation everything else builds on — the 'why you' that
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div className="mb-12 lg:mb-0">
              <h3 className="text-2xl font-bold text-primary mb-4">
                Section 03 — Creative Concepts (10 Ads)
              </h3>
              <p className="text-lg text-slate-600 leading-relaxed italic border-l-4 border-emerald-100 pl-6">
                "10 distinct ad concepts, each exploiting a different gap in your
                market. Every concept includes 4 hook variants, body copy, visual
                asset direction, and CTA buttons. Ready to hand to your
                designer."
              </p>
            </div>
...
Week 4 │ Scale Winners   │ Top 3 performers │ ROAS`}
            ...
            <div className="mb-12 lg:mb-0 lg:order-first">
              <h3 className="text-2xl font-bold text-primary mb-4">
                Section 04 — Testing Roadmap
              </h3>
              <p className="text-lg text-slate-600 leading-relaxed italic border-l-4 border-emerald-100 pl-6">
                "A systematic 4-week A/B testing plan. We don't guess — we test
                hooks first, then formats, then audiences. By week 4, you're
                scaling winners with confidence."
              </p>
            </div>
          </div>
        </div>
