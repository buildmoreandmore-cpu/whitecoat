...
const questions: Question[] = [
  {
    ...
    type: 'text',
    placeholder: 'e.g., Dr. Smith Skincare',
  },
  {
    id: 'founderName',
  ...
  },
  {
    ...
    subtitle: "We'll send your brief details here.",
    type: 'email',
  ...
  },
  {
    ...
    subtitle: 'Optional — if you have one.',
    type: 'url',
  ...
  },
  {
    ...
    question: 'What are your medical credentials?',
    type: 'select',
  ...
  },
  {
    ...
    type: 'text',
    placeholder: 'e.g., Dermatology, Plastic Surgery, Internal Medicine',
  },
  {
    id: 'productType',
  ...
  },
  {
    ...
    type: 'textarea',
    placeholder: 'Describe your target audience (age, concerns, lifestyle...)',
  },
  {
    id: 'timeline',
  ...
  {
    id: 'howDidYouHear',
    question: 'How did you hear about WhiteCoat Brief?',
    type: 'select',
    options: [
      'Google Search',
      'Social Media',
  ...
  },
  {
    ...
    subtitle: "Optional, but we'd love to hear more about your vision.",
    type: 'textarea',
