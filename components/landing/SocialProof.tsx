export default function SocialProof() {
  const testimonials = [
    {
      quote:
        "Finally, a marketing partner who understands I can't just make any claim I want. The brief gave me 10 ad concepts I could actually use — and they knew which ones would get me in trouble.",
      author: 'Dr. Sarah M.',
      role: 'Dermatologist & Skincare Founder',
    },
    {
      quote:
        "I've worked with three agencies. None of them understood how to position my surgical background as a selling point. The WhiteCoat Brief nailed it in the first section.",
      author: 'Dr. James T.',
      role: 'Plastic Surgeon & Supplement Brand',
    },
    {
      quote:
        'The testing roadmap alone was worth it. I stopped guessing and started knowing what worked.',
      author: 'Dr. Rachel K.',
    ...
    <section className="py-24 bg-surface" id="proof">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 flex flex-wrap justify-center items-center gap-12 grayscale opacity-40">
          <div className="font-heading text-2xl font-extrabold text-slate-400 tracking-tighter uppercase italic">
            Shopify
          </div>
          <div className="font-heading text-2xl font-extrabold text-slate-400 tracking-tighter uppercase italic">
            Meta Ads
